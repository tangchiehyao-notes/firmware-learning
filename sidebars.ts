    ...
    'learning-roadmap',
    {
      ...
      items: [
        'openbmc-architecture/index',
        {
          ...
          items: [
            'linux-internals/01-linux-architecture',
            'linux-internals/02-user-space-vs-kernel-space',
            'linux-internals/03-linux-boot-process',
            'linux-internals/04-device-tree',
            'linux-internals/05-linux-driver-model',
            'linux-internals/06-u-boot',
          ],
        },
